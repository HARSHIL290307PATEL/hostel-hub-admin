...
export const AppHeader = ({ title }: AppHeaderProps) => {
  ...
  return (
    <>
            ...
            <DropdownMenu>
              ...
              <DropdownMenuContent align="start" className="w-56 p-2 shadow-soft-lg animate-scale-in">
                ...
                <DropdownMenuItem
                  ...
                  className="flex items-center gap-2 px-3 py-2 rounded-lg cursor-pointer transition-colors text-green-600 focus:text-green-700 focus:bg-green-50"
                >
                  <svg
                    viewBox="0 0 24 24"
                    fill="currentColor"
      ...
      <WhatsAppVerification open={isWhatsAppOpen} onOpenChange={setIsWhatsAppOpen} />
    </>
  );
};
